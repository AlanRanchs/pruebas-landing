  ...
  form.addEventListener("submit", async (e) => {
    ...
    try {
      const res = await fetch(
        "https://pruebas-landing.onrender.com/api/auth/forgot-password",
        {
          method: "POST",
      ...
      if (res.ok) {
        ...
        generalErrorText.textContent =
          "¡Listo! Si el correo está registrado, te llegara un correo enviado un enlace para restablecer tu contraseña.";
      } else {
        generalError.style.display = "block";
        generalErrorText.textContent =
          data.error ||
